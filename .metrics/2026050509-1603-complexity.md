...
| Max Nesting Depth | 3 |
| Avg Nesting Depth | 0.53 |
| Avg Halstead Volume | 143.59 |
| Avg Halstead Difficulty | 4.42 |
| Avg Halstead Effort | 906.37 |
| Avg Halstead Time | 50.35 |

## Structural Duplication Candidates

### language_name (5 exact matches)

| File | Line | Complexity | Lines | Halstead Volume | Halstead Difficulty |
|------|------|------------|-------|-----------------|---------------------|
| ./src/language/c.rs | 33 | 1 | 3 | 18.09 | 1.00 |
| ./src/language/javascript.rs | 45 | 1 | 3 | 18.09 | 1.00 |
| ./src/language/mod.rs | 26 | 1 | 3 | 18.09 | 1.00 |
| ./src/language/python.rs | 34 | 1 | 3 | 18.09 | 1.00 |
| ./src/language/rust.rs | 36 | 1 | 3 | 18.09 | 1.00 |

### can_analyze (4 exact matches)

| File | Line | Complexity | Lines | Halstead Volume | Halstead Difficulty |
|------|------|------------|-------|-----------------|---------------------|
| ./src/language/c.rs | 29 | 1 | 3 | 30.88 | 2.25 |
| ./src/language/javascript.rs | 41 | 1 | 3 | 30.88 | 2.25 |
| ./src/language/python.rs | 30 | 1 | 3 | 30.88 | 2.25 |
| ./src/language/rust.rs | 32 | 1 | 3 | 30.88 | 2.25 |

### parser (4 exact matches)

| File | Line | Complexity | Lines | Halstead Volume | Halstead Difficulty |
|------|------|------------|-------|-----------------|---------------------|
| ./src/language/c.rs | 37 | 2 | 6 | 96.00 | 5.06 |
| ./src/language/javascript.rs | 49 | 2 | 6 | 96.00 | 5.06 |
| ./src/language/python.rs | 38 | 2 | 6 | 96.00 | 5.06 |
| ./src/language/rust.rs | 40 | 2 | 6 | 96.00 | 5.06 |

### test_simple_function (4 exact matches)

| File | Line | Complexity | Lines | Halstead Volume | Halstead Difficulty |
|------|------|------------|-------|-----------------|---------------------|
| ./src/language/c.rs | 92 | 1 | 8 | 134.89 | 2.36 |
| ./src/language/javascript.rs | 88 | 1 | 8 | 134.89 | 2.36 |
| ./src/language/python.rs | 77 | 1 | 8 | 134.89 | 2.36 |
| ./src/language/rust.rs | 79 | 1 | 8 | 134.89 | 2.36 |

### test_boolean_ops (3 exact matches)

| File | Line | Complexity | Lines | Halstead Volume | Halstead Difficulty |
|------|------|------------|-------|-----------------|---------------------|
| ./src/language/c.rs | 148 | 1 | 6 | 74.01 | 1.95 |
| ./src/language/javascript.rs | 140 | 1 | 6 | 74.01 | 1.95 |
| ./src/language/rust.rs | 138 | 1 | 6 | 74.01 | 1.95 |

### test_if_else (2 exact matches)

| File | Line | Complexity | Lines | Halstead Volume | Halstead Difficulty |
|------|------|------------|-------|-----------------|---------------------|
| ./src/language/c.rs | 102 | 1 | 6 | 74.01 | 1.95 |
| ./src/language/javascript.rs | 98 | 1 | 6 | 74.01 | 1.95 |
